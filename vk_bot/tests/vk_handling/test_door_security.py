...
@parametrize_with_cases(glob='*', argnames='mocked_server')
@parametrize(**{'user_id': ADMIN_HARDCODED_LIST,})
...
@pytest.mark.unit
@parametrize_with_cases(cases='.cases_service_id', argnames='service_id')
@parametrize_with_cases(glob='*yes', argnames='mocked_server')
...
@pytest.mark.unit
@parametrize_with_cases(cases='.cases_service_id', argnames='service_id')
@parametrize_with_cases(glob='*no', argnames='mocked_server')
@parametrize(**{'user_id': [188477847]})
